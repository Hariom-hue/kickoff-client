...
export default function AdminLogin({ onSuccess }) {
    ...
    try {
      ...
      if (data.success) {
        ...
        if (next >= 5) {
          ...
          setError(`Wrong credentials — ${5 - next} attempt${5 - next !== 1 ? "s" : ""} left`);
        }
      }
    } catch {
      setError("Cannot reach server. Is node index.js running?");
    }
    setLoading(false);
  };
  ...
  const handleDigit = (idx, val) => {
    ...
    if (idx === 5 && v) {
      ...
      if (full.length === 6) setTimeout(() => verifyCode(full), 80);
    }
  };
  ...
  const verifyCode = async (fullCode) => {
    ...
    try {
      ...
      const data = await res.json();
      if (data.success) {
        sessionStorage.setItem("adminAuth", data.adminToken); // ← saves JWT
        onSuccess();
      } else {
    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 400 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 36 }}>
          ...
          <p style={{ color: "#333", fontSize: 11, letterSpacing: "0.15em", textTransform: "uppercase", marginTop: 4 }}>
            Admin Portal
          </p>
        </div>
          ...
          <div style={{ padding: "20px 28px", borderBottom: "1px solid #1a1a1a" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
              <div style={{
                ...
                background: step === 2 ? "rgba(200,255,0,0.1)" : "#1a1a1a",
                border: `1px solid ${step === 2 ? "#c8ff00" : "#252525"}`,
                display: "flex", alignItems: "center", justifyContent: "center",
              ...
              <div>
                ...
                <p style={{ color: "#444", fontSize: 11, margin: 0 }}>
                  {step === 1 ? "Enter your admin credentials" : "Check terminal for your 6-digit code"}
                </p>
              </div>
            </div>
            {/* Progress */}
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                <div>
                  ...
                  <input
                    ...
                    disabled={locked}
                    style={{ ...inputStyle, border: "1px solid #252525", transition: "border-color 0.2s" }}
                  />
                </div>
                <div>
                  ...
                  <div style={{ display: "flex", gap: 5 }}>
                    {Array.from({ length: 5 }).map((_, i) => (
                      <div key={i} style={{
                        ...
                        background: i < attempts ? "#ef4444" : "#1e1e1e",
                ...
                <button
                  ...
                  style={{
                    padding: 14, background: locked ? "#1a1a1a" : "#c8ff00",
                    border: "none", borderRadius: 10,
                    color: locked ? "#444" : "#0a0a0a",
                    fontWeight: 700, fontSize: 13, letterSpacing: "0.08em",
                    textTransform: "uppercase", cursor: locked ? "not-allowed" : "pointer",
            ...
            {step === 2 && (
              <div className="fade-up" style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                <p style={{ color: "#555", fontSize: 13, lineHeight: 1.7, margin: 0 }}>
                  Check your <span style={{ color: "#c8ff00", fontWeight: 700 }}>server terminal</span> for the 6-digit OTP code. It expires in 5 minutes.
                </p>
                  ...
                  {codeDigits.map((d, i) => (
                    <input
                      ...
                      style={{
                        ...
                        background: "#0c0c0c",
                        border: `2px solid ${d ? "#c8ff00" : "#252525"}`,
                ...
                <button
                  ...
                  style={{
                    padding: 14,
                    background: codeDigits.join("").length === 6 ? "#c8ff00" : "#1a1a1a",
                    border: "none", borderRadius: 10,
                    color: codeDigits.join("").length === 6 ? "#0a0a0a" : "#444",
                    fontWeight: 700, fontSize: 13, letterSpacing: "0.08em",
                    textTransform: "uppercase",
                    cursor: codeDigits.join("").length < 6 ? "not-allowed" : "pointer",
                    fontFamily: "'DM Sans', sans-serif"
                  }}>
                ...
                <button
                  onClick={() => { setStep(1); setCodeDigits(["","","","","",""]); setError(""); }}
                  style={{
        ...
        <p style={{ color: "#1a1a1a", fontSize: 11, textAlign: "center", marginTop: 20 }}>
